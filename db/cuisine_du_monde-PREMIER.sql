...
--
-- Hôte : 127.0.0.1
-- Généré le :  mer. 19 déc. 2018 à 14:50
...
--
-- Index pour la table `est_du_type`
--
...
--
ALTER TABLE `recette`
  MODIFY `numRecette` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `utilisateur`
  MODIFY `numUser` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
